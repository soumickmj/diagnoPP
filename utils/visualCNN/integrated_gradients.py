...
from utils.visualCNN.misc_functions import get_example_params, convert_to_grayscale, save_gradient_images
...
def execute(model, inputs, classID, file_name_to_export, steps=100):
    try:
        # Vanilla backprop
        IG = IntegratedGradients(model)
        # Generate gradients
        integrated_grads = IG.generate_integrated_gradients(inputs, classID, steps)
